(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    6835: function (e, t, i) {
      Promise.resolve().then(i.bind(i, 80082));
    },
    49498: function (e) {
      e.exports = {
        page_container: "page_page_container__xF7yI",
        abstract_text: "page_abstract_text__siVc5",
        paper_title: "page_paper_title__o4XXa",
        subtitle: "page_subtitle__JoR3B",
        title_section: "page_title_section__pGMl5",
        section: "page_section__IuIy3",
        image_container: "page_image_container__5BDUc",
        image_container_caption_no: "page_image_container_caption_no__d7ZBk",
        image_container_image: "page_image_container_image__sNhxZ",
        paper_link: "page_paper_link__0kQcm",
        list: "page_list__WDrtc",
        force: "page_force__G5XAs",
        fadeIn: "page_fadeIn__y_FAv",
      };
    },
    80082: function (e, t, i) {
      "use strict";
      i.r(t);
      var n = i(64618),
        s = i(27024),
      ...
      let r = () =>
        (0, n.jsx)(s.Suspense, {
          ...
          children: (0, n.jsxs)("div", {
            className: a().page_container,
            children: [
              (0, n.jsxs)("section", {
                className: a().title_section,
                children: [
                  (0, n.jsx)("p", {
                  ...
                  (0, n.jsx)("p", {
                    ...
                    style: { fontSize: "10px" },
                    children: "Written by Const, core dev @ Opentensor",
                  }),
                ],
              }),
              (0, n.jsxs)("section", {
                ...
                children: [
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      ...
                      " computer - not directly owned by any single entity, and available for anyone's use. To run, govern, contribute to, and importantly ",
                      (0, n.jsx)("i", { children: "profit" }),
                      " from the technological products it produces.",
                    ],
                  }),
                ],
              }),
              ...
              (0, n.jsxs)("section", {
                ...
                children: [
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      "Bitcoin itself, i.e. the code of the protocol which stitches this equilibrium together, does not itself run any computers, nor in recent years does it even define the way in which computing power proves its existence to the network. Rather, it defines the way in which computing power is ",
                      (0, n.jsx)("i", { children: "validated" }),
                      " - that is, the manner in which the computers in the system ",
                      (0, n.jsx)("i", { children: "agree together" }),
                      " who has the most computing power and thus the most reward in the system. This is a ",
                      (0, n.jsx)("strong", {
                        children: "digital commodity incentive mechanism",
                      }),
                      ".",
                    ],
                  }),
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      "In summary, digital commodity incentive mechanisms are the ",
                      (0, n.jsx)("i", { children: "perfect markets" }),
                      ", and perfect markets have the amazing quality that, when aligned, they are unstoppable and unequivocally powerful. For instance, Bitcoin miners worldwide continuously and aggressively find ways to reduce the cost to mine Bitcoin by purchasing cheap hardware, or finding unused lakes of available energy. The system is antifragile, constantly killing off bad competition. It is unclosable. Anyone can join, no questions asked, and contributions get paid ",
                      (0, n.jsx)("i", { children: "directly" }),
                      " and",
                      (0, n.jsx)("i", { children: " continuously" }),
                      ", no contracts. No HR department − this is ",
                      (0, n.jsx)("i", { children: "capitalism" }),
                      " ",
                      "in its purest form.",
                    ],
                  }),
                ...
                children: [
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      ...
                      (0, n.jsx)("i", {
                        children:
                          " without any information moving between the validator set and the chain",
                      }),
                      ". This would be impossible on nearly any available blockchain.",
                    ],
                  }),
                  (0, n.jsxs)("p", {
                    children: [
                      ...
                      (0, n.jsx)("i", {
                        children:
                          "the way defined by the people who write the consensus mechanisms for the individual subnets",
                      }),
                      ".",
                    ],
                  }),
                  (0, n.jsxs)("p", {
                    children: [
                      ...
                      (0, n.jsx)("strong", {
                        children: " agnostic to what is being measured",
                      }),
                      ", and allows for fuzzy consensus around ",
                      (0, n.jsx)("i", { children: "probabilistic truths" }),
                      " - truths like intelligence. Indeed, YC was essential for the validation of intelligence, given the nature of that amorphous information theoretic commodity.",
                    ],
                  }),
                  (0, n.jsxs)("p", {
                    children: [
                      ...
                      " and thus make the problem being solved, or the way it is solved, ",
                      (0, n.jsx)("strong", { children: "immutable" }),
                      " down the road. Yuma Consensus has no such limitations.",
                    ],
                  }),
                ],
              }),
              (0, n.jsxs)("section", {
                ...
                children: [
                  (0, n.jsx)("p", {
                    className: a().subtitle,
                    children: "Why should business people care?",
                  }),
                  (0, n.jsxs)("p", {
                    children: [
                      "The ability to ",
                      ...
                      (0, n.jsx)("strong", {
                        children:
                          "concurrently run within a single token ecosystem",
                      }),
                      " is not",
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      ...
                      (0, n.jsx)("strong", {
                        children:
                          " backed by an incentivized, adapting and ever-improving infrastructure",
                      }),
                      ". TAO ",
              ...
              (0, n.jsxs)("section", {
                ...
                children: [
                  (0, n.jsx)("p", {
                    className: a().subtitle,
                    children: "What's in it for developers?",
                  }),
                  (0, n.jsx)("p", {
                    children:
                  ...
                  (0, n.jsxs)("ol", {
                    ...
                    children: [
                      (0, n.jsx)("li", {
                        children: " Machine learning engineers",
                      }),
                      (0, n.jsx)("li", { children: "Intelligence companies" }),
                      (0, n.jsx)("li", { children: "Trading firms" }),
                      (0, n.jsx)("li", {
                        children: "Network infrastructure companies",
                      }),
                      (0, n.jsx)("li", {
                        children: "Data acquisition companies",
                      }),
                      (0, n.jsx)("li", { children: "Oracles" }),
                      (0, n.jsx)("li", {
                        children: "Infrastructure providers",
                      }),
                      (0, n.jsx)("li", {
                        children: "Mining teams for all of the above",
                      }),
                      (0, n.jsx)("li", {
                        children:
                          "Anyone who wants to have a say in the future of technology.",
                      }),
                    ],
                  }),
                  (0, n.jsxs)("p", {
              ...
              (0, n.jsxs)("section", {
                ...
                children: [
                  (0, n.jsx)("p", {
                    className: a().subtitle,
                    children: "Open Markets, Open Ownership",
                  }),
                  (0, n.jsxs)("p", {
                    children: [
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      "In open source we give the code away; in open ownership we give the control away, to the same effect and from the same principle -",
                      (0, n.jsxs)("strong", {
                        children: [
                          " ",
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      "This is as simultaneously ",
                      (0, n.jsx)("strong", { children: "vital" }),
                      " - the only thing ",
                      (0, n.jsx)("i", { children: "capable" }),
                      " of competing with the largest corporations is the ",
                      (0, n.jsx)("i", { children: "unity of everyone " }),
                      "- as it is",
                      (0, n.jsx)("strong", { children: " ethical" }),
                      ". The excessive centralization of control, especially around AI, poses the greatest risk to the human race. The concentration of power",
                      (0, n.jsx)("strong", { children: " inevitably" }),
                      " creates biased decision-making, controlled access to benefits, and significant abuse.",
                    ],
                  }),
                  (0, n.jsxs)("p", {
                    children: [
                      "Satoshi understood that the centralization of power over money ",
                      (0, n.jsx)("i", { children: "inevitably" }),
                      " creates corruption. This is the reason that Bitcoin sought to decentralize finance. This truth maps self-evidently onto humankind's most valuable digital resources. AI must not be owned by the few for the same, and exponentially more dangerous, threat.",
                    ],
                  }),
                ],
              }),
              (0, n.jsxs)("section", {
                ...
                children: [
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      ...
                      (0, n.jsxs)("strong", {
                        children: [
                          " ",
                          "abstracted computing markets are the most powerful tool humanity has ever had for aligning digital resources.",
                        ],
                      }),
                    ],
                  }),
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      "We are approaching a forking point for mankind; down one road is the centralization of power and resources, in large regulated industries, who have entrenched and overbearing access to the best-in-class intelligence and computers. Down the other road is the",
                      (0, n.jsxs)("strong", {
                        children: [
                          " ",
                          "potential for sharing these resources through open protocols, via technological foundations, which enable global participation and ownership",
                        ],
                      }),
                      ".",
                    ],
    ...
    64618: function (e, t, i) {
      "use strict";
      e.exports = i(1432);
    },
  },
  function (e) {
    e.O(0, [3132, 1744], function () {
      return e((e.s = 6835));
    }),
      (_N_E = e.O());
  },
